...
--help|--help-long)
	local help_long
	case $1 in # todo: help message to be parsed only when not sourced by shell. reduce RAM usage, this --help-long is a bit huge ..
		--help-long) help_long='';;
		*) unset help_long;;
	esac
	printf %s\\n \
...
case "${0##*/}" in
	...
	*) ;; # when file was sourced by shell, just loads the function
esac
